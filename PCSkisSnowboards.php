<html>
    ...
    <body style="background-color:#B0C4DE;">
        <h1 style="color:#696969;">Park City Sport Skis and Snowboards</h1>
        <hr>
            <p style="color:#696969;">The current Ski and Snowboard inventory of Park City Sport is:</p>
        <?php
            ...
            try {
                ...
                $select ='SELECT * FROM SkisSnowboards WHERE Location_idLocation="ParkCitySport"';
                $sql = $select;
