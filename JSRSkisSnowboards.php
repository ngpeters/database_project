<html>
    ...
    <body style="background-color:#B0C4DE;">
        <h1 style="color:#696969;">Jakes Ski Rentals Skis and Snowboards</h1>
        <hr>
            <p style="color:#696969;">The current Ski and Snowboard inventory of Jakes Ski Rentals is:</p>
        <?php
            ...
            try {
                ...
                $select ='SELECT * FROM SkisSnowboards WHERE Location_idLocation="JakesSkiRentals"';
                $sql = $select;
